...
function Grid() {
  return (
    <div className='w-full mt-[10px] md:mt-[0px] grid max-h-[2500px] grid-cols-1 grid-row-6 md:grid-cols-2 md:grid-row-3'>
        ...
        <div className='w-full bg-red-500'>
            <div className='h-full w-full flex items-center justify-center'>
            <img src={pic2} className='w-full h-full'/>
            </div>
        </div>
        <div className='w-full text-center md:text-start flex items-center justify-center p-10'>
        ...
        <img src={pic3} className=' w-[100%] h-[100%]'/>
       <div className='absolute max-h-[100px] w-full flex items-center justify-center text-center px-[150px] top-[400px]'>
       <div className=''>
       <h1 id='text' className='text-center font-extrabold text-2xl'>
        ...
        <img src={pic4} className=' w-[100%] h-[100%]'/>
       <div className='absolute max-h-[100px] w-full flex items-center justify-center text-center px-[150px] top-[400px]'>
       <div className=''>
       <h1 id='text' className='text-center font-extrabold text-2xl'>
          Photography
